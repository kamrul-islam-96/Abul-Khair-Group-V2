...
import { Facebook, Linkedin, Twitter, Youtube, Mail, Phone, MapPin, Send, ArrowRight } from "lucide-react";
...
export const Footer = () => {
  ...
  return (
    <div className="bg-white pt-20 pb-10 border-t border-slate-100">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
              Leading the path of excellence for over decades. Committed to sustainable growth and quality innovations in every industry.
            </p>
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm mb-4">Subscribe to receive latest corporate updates.</p>
        ...
        <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8">
            <a href="#" className="text-slate-400 hover:text-slate-600 text-xs font-bold uppercase tracking-wider">Privacy Policy</a>
            <a href="#" className="text-slate-400 hover:text-slate-600 text-xs font-bold uppercase tracking-wider">Terms of Use</a>
          </div>
        </div>
      </div>
    </div>
